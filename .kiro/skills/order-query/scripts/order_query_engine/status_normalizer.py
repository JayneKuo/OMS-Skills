...
from order_query_engine.models import NormalizedStatus, StatusMapping
...
STATUS_MAP: dict[int, StatusMapping] = {
    ...
    25: StatusMapping(main_status="已解除分配", category="特殊"),
}
...
STATUS_STR_MAP: dict[str, StatusMapping] = {
    ...
    "DEALLOCATED": StatusMapping(main_status="已解除分配", category="特殊"),
